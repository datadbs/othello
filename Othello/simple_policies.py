...
parserDQN.add_argument('--gamma', type=float, default=0.95)
parserDQN.add_argument('--lr', type=float, default=0.005)
parserDQN.add_argument('--batch_size', type=int, default=32)
parserDQN.add_argument('--eps', type=float, default=0.5)
parserDQN.add_argument('--eps_decay', type=float, default=0.75)
parserDQN.add_argument('--eps_min', type=float, default=0.01)
parserDQN.add_argument('--temp_save_freq', type=int, default=250)
...
class DQNPolicy(object):
    ...
    def get_action(self, state, rand_state):
